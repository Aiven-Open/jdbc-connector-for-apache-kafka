...
public class TestBase {
  ...
  public Map<String, String> getPropsAllFields(String errorPolicy, String mode, Boolean autoCreate) {
    ...
    if (autoCreate) {
      if (Objects.equals(mode.toLowerCase(), "upsert")) {
        props.put(EXPORT_MAPPINGS, upsertAll1 + " AUTOCREATE;" + upsertAll2);
      } else {
        props.put(EXPORT_MAPPINGS, insertAll1 + " AUTOCREATE;" + insert2);
      }
    } else {
      if (Objects.equals(mode.toLowerCase(), "upsert")) {
        props.put(EXPORT_MAPPINGS, upsertAll1 + ";" + upsertAll2);
      } else {
        props.put(EXPORT_MAPPINGS, insertAll1 + ";" + insertAll2);
      }
    }
    return props;
  }
  ...
  public Map<String, String> getPropsAllFieldsAutoCreatePK() {
    ...
    map.put(EXPORT_MAPPINGS, upsertAll1 + " AUTOCREATE PK f1,f2;" + upsertAll2 + " AUTOCREATE PK f3");
    return map;
  }
  ...
  public Map<String, String> getPropsSelectedFieldsAutoCreatePKBad() {
    ...
    map.put(EXPORT_MAPPINGS, insert1 + " AUTOCREATE;" + insert2 + " AUTOCREATE PK f13");
    return map;
  }
  ...
  public Map<String, String> getPropsSelectedFields(String errorPolicy, String mode, Boolean autoCreate) {
    ...
    if (autoCreate) {
      if (Objects.equals(mode, "upsert")) {
        props.put(EXPORT_MAPPINGS, upsert1 + " AUTOCREATE;" + upsert2);
      } else {
        props.put(EXPORT_MAPPINGS, insert1 + " AUTOCREATE;" + insert2);
      }
    } else {
      if (Objects.equals(mode, "upsert")) {
        props.put(EXPORT_MAPPINGS, upsert1 + ";" + upsert2);
      } else {
        props.put(EXPORT_MAPPINGS, insert1 + ";" + insert2);
      }
    }
    return props;
  }

...
public abstract class BaseDialectTest<T extends GenericDatabaseDialect> {
  ...
  public void bindFieldPrimitiveValues() throws SQLException {
    ...
    verifyBindField(++index, Decimal.schema(0),
    ...
    verifyBindField(++index, Date.SCHEMA, new java.util.Date(0)).setDate(index,
        new java.sql.Date(0), utcCalendar);
    verifyBindField(++index, Time.SCHEMA, new java.util.Date(1000))
        .setTime(index, new java.sql.Time(1000), utcCalendar);
    verifyBindField(++index, Timestamp.SCHEMA, new java.util.Date(100))

...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  public static ConfigDef baseConfigDef() {
    return new ConfigDef()
        ...
        .define(CONNECTION_USER_CONFIG, Type.STRING, null, Importance.MEDIUM, CONNECTION_USER_DOC, DATABASE_GROUP, 2, Width.LONG, CONNECTION_USER_DISPLAY)
        .define(CONNECTION_PASSWORD_CONFIG, Type.PASSWORD, null, Importance.MEDIUM, CONNECTION_PASSWORD_DOC, DATABASE_GROUP, 3, Width.SHORT, CONNECTION_PASSWORD_DISPLAY)

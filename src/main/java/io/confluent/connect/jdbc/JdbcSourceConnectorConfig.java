...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  public static ConfigDef baseConfigDef() {
    return new ConfigDef()
        ...
        .define(TIMESTAMP_DELAY_INTERVAL_MS_CONFIG, Type.LONG, TIMESTAMP_DELAY_INTERVAL_MS_DEFAULT, Importance.LOW, TIMESTAMP_DELAY_INTERVAL_MS_DOC, CONNECTOR_GROUP, 5, Width.MEDIUM, TIMESTAMP_DELAY_INTERVAL_MS_DISPLAY);
  }

...
public class ColumnDefinition {
     ...
     */
    public ColumnDefinition forTable(final TableId tableId) {
        if (tableId().equals(tableId)) {
            return this;
        }
        final ColumnId newId = new ColumnId(tableId, this.id().name());
     ...
     */
    public ColumnDefinition asPartOfPrimaryKey(final boolean isPrimaryKey) {

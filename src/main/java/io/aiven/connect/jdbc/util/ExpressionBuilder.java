...
public class ExpressionBuilder {
    ...
    public interface ListBuilder<T> {
         ...
         * @return this builder to enable methods to be chained; never null
         */
        default ExpressionBuilder of(final Iterable<? extends T> objects1, final Iterable<? extends T> objects2) {
            of(objects1);
            return of(objects2);
        }
        ...
        default ExpressionBuilder of(
            final Iterable<? extends T> objects1,
            final Iterable<? extends T> objects2,
            final Iterable<? extends T> objects3
        ) {
            of(objects1);
            of(objects2);
            return of(objects3);
     ...
     */
    public ExpressionBuilder(final IdentifierRules rules, final boolean quoteIdentifiers) {

...
public class StructFieldsDataExtractorTest {
    ...
    public void returnAllFieldsAndTheirBytesValue() {
        ...
        StructFieldsDataExtractor dataExtractor = new StructFieldsDataExtractor(true, new HashMap<String, String>());
        List<Pair<String, PreparedStatementBinder>> binders = dataExtractor.get(struct);

        HashMap<String, PreparedStatementBinder> map = new HashMap<>();
        for (Pair<String, PreparedStatementBinder> p : binders)
    ...
    public void returnAllFieldsAndApplyMappings() {
        ...
        StructFieldsDataExtractor dataExtractor = new StructFieldsDataExtractor(true, mappings);
        List<Pair<String, PreparedStatementBinder>> binders = dataExtractor.get(struct);
    ...
    public void returnOnlyTheSpecifiedFields() {
        ...
        StructFieldsDataExtractor dataExtractor = new StructFieldsDataExtractor(false, mappings);
        List<Pair<String, PreparedStatementBinder>> binders = dataExtractor.get(struct);

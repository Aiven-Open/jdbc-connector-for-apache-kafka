...
release = '5.1.0-beta180905054157'
...
htmlhelp_basename = 'KafkaConnectJDBCDoc'
...
latex_documents = [
  ('index', 'KafkaConnectJDBC.tex', u'Kafka Connect JDBC Documentation',
...
man_pages = [
    ('index', 'kafkaconnectjdbc', u'Kafka Connect JDBC',
     [u'Confluent, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'KafkaConnectJDBC', u'Kafka Connect JDBC Documentation',
   u'Confluent, Inc.', 'KafkaConnectJDBC',
   'Kafka Connector for JDBC sources',
   'Miscellaneous'),
]
